                ...
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">{{$user->nama_siswa}}</td>
                            <td class="border px-4 py-2">{{$user->kelas->nama_kelas}}</td>
                            <td class="border px-4 py-2">{{$user->jurusan->nama_jurusan}}</td>
                            <td class="border px-4 py-2">{{$user->nis}}</td>
                            <td class="border px-4 py-2">{{$user->email}}</td>
                            <td class="border px-4 py-2">
                                <div class="flex justify-center">
                                    <a href="{{route('user.edit',$user->id)}}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-l" title="Edit">
